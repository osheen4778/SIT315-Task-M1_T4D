...
void motionDetected2() {
  ...
  digitalWrite(led4, !state4);   // toggle LED
  state4 = !state4;              // update variable state
  if (state4 == HIGH) {
...
//void motionDetected4() {
 // digitalWrite(led5, !state5);   // toggle LED
 // state5 = !state5;              // update variable state
 // if (state5 == HIGH) {
   // Serial.println("Motion 4 detected!"); 
 // } 
 // else {
 //   Serial.println("Motion 4 stopped!");
 // }
//}
